  ...
  return (
    <div>
      ...
      <section className="relative flex min-h-[calc(100svh_-_var(--header-height))] items-start justify-center overflow-hidden border-b bg-background pt-12 pb-16 sm:pt-24">
        ...
        <div className="pointer-events-none absolute inset-x-6 top-6 z-0 h-[calc(100svh_-_var(--header-height)_-_3rem)] overflow-hidden rounded-lg border">
          <LogoRain />
        </div>
        {/* px-6 matches the tank's inset-6 walls, so the card's edges line up
            with the tank's on narrow screens */}
        <div className="pointer-events-none relative z-10 flex w-full max-w-[1200px] flex-col items-center gap-5 px-6">
          ...
          {/* px-4 keeps the longest wrapped line clear of the inset-6 frame */}
          ...
          <div className="pointer-events-auto mt-16 w-full rounded-lg border bg-background p-2 shadow-lg">
