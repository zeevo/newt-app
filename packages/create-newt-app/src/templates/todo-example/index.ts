...
// Every mode that runs Nest inside the web app imports the api as TS source,
// so it needs an entrypoint re-exporting what the web app resolves.
export const todoExampleApiIndex: Module = {
  templates: [apiIndex],
};
